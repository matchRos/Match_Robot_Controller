...
def compute_trajectories(robot0_path,robot1_path,robot0_v,robot0_w,robot1_v,robot1_w):
    control_rate = 100.0
    ...
    while not rospy.is_shutdown() and target_reached == False:
        ...
        dists_to_cp = [robot0_dist_to_cp,robot1_dist_to_cp]
        dists_to_cp.sort()
        #print(dists_to_cp)



        robot0_acc_lin = (robot0_dist_to_cp / dists_to_cp[len(dists_to_cp)-1]) * target_vel_lin/control_rate - robot0_current_velocity_lin
        robot1_acc_lin = (robot1_dist_to_cp / dists_to_cp[len(dists_to_cp)-1]) * target_vel_lin/control_rate - robot1_current_velocity_lin
    ...
    if len(robot0_xhat) == len(robot1_xhat):
