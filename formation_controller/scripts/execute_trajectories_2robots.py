...
class execute_trajectories_node():
    ...
    def run(self):
        while not self.robot0_trajectory_received == True and not self.robot1_trajectory_received == True and not rospy.is_shutdown():
            rospy.sleep(0.1)
        ...
        while not rospy.is_shutdown() and idx < len(self.robot0_v):
            ...
            self.actual_pose_broadcaster(self.robot0_act_pose,self.robot1_act_pose)
    ...
    def target_pose_broadcaster(self,robot0_target_pose,robot1_target_pose):
    ...
    def actual_pose_broadcaster(self,robot0_act_pose,robot1_act_pose):
