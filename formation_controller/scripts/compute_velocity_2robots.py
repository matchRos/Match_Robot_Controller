...
from compute_trajectories_2robots import compute_trajectories
...
class compute_velocity():
    ...
    def run(self):
        ...
        compute_trajectories(self.robot0_path,self.robot1_path,self.robot0_v,self.robot0_w,self.robot1_v,self.robot1_w)
                # set start pose
